...
class SkeletonManager(object):
    ...
    def _remove_stored_data(self, subj, uuid):
        ...
        del self.accumulate_robot[msg.uuid]
        del self.accumulate_rgb_images[msg.uuid] 
        del self.accumulate_rgb_sk_images[msg.uuid]
        del self.accumulate_depth_images[msg.uuid] 
